                          ...
                          <div className="flex-1">
                            ...
                            <div className="bg-black rounded p-2 font-mono text-xs">
                              ...
                              <div className="text-zinc-400 flex items-center gap-2">
                                Value:{" "}
                                <span className="text-emerald-400">
                                  {domain.verificationToken.substring(0, 32)}...
                                </span>
                                <Button
                                  size="sm"
                                  variant="ghost"
          ...
          <div className="space-y-3 text-sm text-zinc-400">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-zinc-500">
                  Add the provided TXT record to your DNS to verify ownership
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-zinc-500">
                  Select verified domains when creating deployments for custom
                  URLs
                </p>
              </div>
            </div>
